...
action_16 (5) = happyGoto action_9
...
happyReduction_1 (HappyAbsSyn5  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (Ascribe happy_var_1 happy_var_3
	)
...
happyReduction_4 ((HappyAbsSyn4  happy_var_6) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn5
		 (Pi happy_var_4 (abstract (`elemIndex` [happy_var_2]) happy_var_6)
	) `HappyStk` happyRest
...
happyReduction_6 ((HappyAbsSyn4  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn5
		 (Lam (abstract (`elemIndex` [happy_var_2]) happy_var_4)
	) `HappyStk` happyRest
